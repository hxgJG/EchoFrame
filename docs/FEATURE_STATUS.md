...
| 主题 | 浅色/深色、主题色、动态取色 | 🟡 | 正式 Logo 和三端图标已落地；浅色/深色、四种品牌主题色及音频金橙/视频青绿语义色已实现；未实现入口明确禁用 | Material You 真正取色 |
...
3. 正式 Logo、Android/iOS/HarmonyOS 图标、四种品牌主题色及音频金橙/视频青绿语义色；未接入的动态取色入口明确禁用。
