# Lumio Phase 2b Local Persistence Implementation Plan
...
- Produces: `LumioSettings.toJson()`, `LumioSettings.fromJson(Map<String, Object?>)`

- [x] **Step 1: Add JSON helpers to `MediaItem`**
- [x] **Step 2: Add JSON helpers to `Playlist`**
- [x] **Step 3: Add JSON helpers to `LumioSettings`**
...
- Produces: MethodChannel `lumio/app_storage` methods `load` and `save`
