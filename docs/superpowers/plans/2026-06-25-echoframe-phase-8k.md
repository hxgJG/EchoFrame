# EchoFrame Phase 8k ASS Subtitles and Reorder Implementation Plan
...
**Interfaces:**
- Produces: `EchoAppState.reorderQueue(int oldIndex, int newIndex)`
- Produces: `EchoAppState.reorderPlaylistItems(String playlistId, int oldIndex, int newIndex)`
