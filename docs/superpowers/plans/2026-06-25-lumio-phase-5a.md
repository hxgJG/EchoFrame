# Lumio Phase 5a Backup Restore Implementation Plan
...
**Interfaces:**
- Updates: MethodChannel `lumio/app_storage`
...
**Interfaces:**
- Produces: `LumioAppState.backupStatusMessage`
- Produces: `LumioAppState.createBackup()`
- Produces: `LumioAppState.restoreLatestBackup()`
