# Lumio Phase 8e Video Fullscreen Gestures Implementation Plan
...
- Consumes: `LumioAppState.adjustBrightness`
- Consumes: `LumioAppState.adjustVolume`
...
**Interfaces:**
- Produces: `LumioAppState.adjustBrightness(double delta)`
- Produces: `LumioAppState.adjustVolume(double delta)`
