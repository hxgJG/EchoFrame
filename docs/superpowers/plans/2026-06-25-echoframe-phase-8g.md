# EchoFrame Phase 8g Equalizer Presets Implementation Plan
...
- Produces: `EchoAppState.setEqualizerPreset(EqualizerPreset preset)`
...
**Interfaces:**
- Consumes: `EchoAppState.setEqualizerPreset`
