# EchoFrame Phase 4a Android Video Surface Implementation Plan
...
**Interfaces:**
- Updates: MethodChannel `echoframe/playback` method `play` returns `textureId` for video.
...
**Interfaces:**
- Consumes: `EchoAppState.videoTextureId`
- Consumes: `EchoAppState.enterPictureInPicture()`
