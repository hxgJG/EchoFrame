# Lumio Phase 8o Music Folder Browsing Implementation Plan
...
**Interfaces:**
- Produces: `List<String> LumioAppState.audioFolders`
- Produces: `List<MediaItem> LumioAppState.itemsForAudioFolder(String folder)`
...
**Interfaces:**
- Consumes: `LumioAppState.audioFolders`
- Consumes: `LumioAppState.itemsForAudioFolder`
